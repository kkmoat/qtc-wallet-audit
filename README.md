...
对应市场源码版本：`d21c4e1362313e7e0eb1e632aba25288b221fa2e`（2026-09-11）。这是用于标识来源的版本号，原市场仓库保持私密；公众可以直接查看本仓库的源码。每个原样复制或从源码包解出的文件都有 [SHA-256 清单](snapshot.json)。这不是第三方安全审计报告，也不是“绝对安全”证书。
